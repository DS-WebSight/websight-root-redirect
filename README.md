...
Root Redirect Module

On a local instance, JCR root node has `sling:redirect` resource type. 
This module does not override Sling redirection behavior, so to enable application 
...
Dynamic Solutions WebSight (Root Redirect) - Root Redirect
